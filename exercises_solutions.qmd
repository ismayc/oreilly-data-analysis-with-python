...
top_gdp_2012_2016 = economies[(economies['gdp_percapita'] > 40000) & (economies['year'] <= 2016)]
top_gdp_2012_2016.head()
```
...
```{python}
# Remove rows with missing values in specific columns
populations_cleaned_subset = populations.dropna(subset=['infant_mortality'])
...
fig = make_subplots(rows=1, cols=2,
                    subplot_titles=('GDP Per Capita Over Years for Germany',
                                    'GDP Per Capita in Western Europe in 2020'))

# Line chart of GDP Per Capita for Germany
deu_data = economies[economies['code'] == 'DEU']
line_chart = go.Scatter(x=deu_data['year'], y=deu_data['gdp_percapita'], mode='lines+markers', name='Germany')
fig.add_trace(line_chart, row=1, col=1)

# Bar chart of GDP Per Capita for Western European countries in 2020
western_europe = ['AUT', 'BEL', 'CHE', 'DEU', 'FRA', 'LUX', 'NLD']
western_data_2020 = data_2020[data_2020['code'].isin(western_europe)]
bar_chart = go.Bar(x=western_data_2020['code'], y=western_data_2020['gdp_percapita'], name='2020')
